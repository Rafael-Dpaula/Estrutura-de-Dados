...
int main()
{
    ...
    do
    {
        ...
        cout << "3. Mostrar Pre-Ordem" << endl;
        cout << "4. Mostrar Simetrica (In-Ordem)" << endl;
        cout << "5. Mostrar Pos-Ordem" << endl;
        ...
        case 1:
            ...
            cin >> valor;
            inserir_avl(&raiz, valor);
            break;
        case 2:
            cout << "Digite o valor a remover: ";
            cin >> valor;
            remover_avl(&raiz, valor);
            break;
        case 3:
            cout << "Pre-Ordem: ";
            mostra_preOrdem(raiz);
            cout << endl;
            break;
        case 4:
            cout << "Simetrica: ";
            mostra_simetrica(raiz);
            cout << endl;
            break;
        case 5:
            cout << "Pos-Ordem: ";
            mostra_posOrdem(raiz);
            cout << endl;
            break;
        case 6:
            cout << "Digite o nome do arquivo (ex: entrada.txt): ";
            cin >> nomeArquivo;
            ler_arquivo(&raiz, nomeArquivo);
            break;
        case 0:
